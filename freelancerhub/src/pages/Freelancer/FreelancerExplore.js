...
const FreelancerExplore = () => {
  ...
  const projects = [
    {
      ...
      preferQuali: "Diploma/Degree in Computer Science",
      date: "27/4/2024",
      duration: "1 month",
    },
    {
  ...
  const ProjectList = ({ projects, onProjectClick, selectedProjectId }) => {
    return (
      <div
        className={`flex flex-col ${selectedProjectId ? "w-3/5" : "flex-grow"}`}
      >
        {projects.map((blog) => (
          <div
            className={`card ${
              selectedProjectId === blog.id ? "selected" : ""
            } mb-4`}
            key={blog.id}
      ...
      <div className="modal-overlay" onClick={onClose}>
        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          <div className="modal-header">
            <h2 id className="view-application-header">
              View Project
            </h2>
          ...
          {/* Pass project to ProjectDetails */}
        </div>
      </div>
    );
  };
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 ">
          ...
          <div className="flex items-center justify-between self-stretch rounded-[39px] bg-white px-5 py-2">
            <div className="flex items-center gap-4">
              <img
                src={search}
                alt="search_one"
                className="h-[42px] w-[42px] align-middle"
              />
              <input
                type="text"
            ...
            <div className="flex items-center gap-4">
              <img
                src={catergory}
                alt="iconoirpinalt"
                className="h-[33px] w-[33px] align-middle"
              />
      ...
      <div className="flex justify-center items-center h-full pt-10">
        <div className="flex flex-row">
          <div className="flex flex-col w-1/4">
            {dropdowns.map((dropdown, index) => (
              <details
                key={index}
                open
                className="mb-4 rounded-xl bg-white shadow overflow-hidden"
                onToggle={(e) => {
                  ...
                  dropdown.options.map((option, i) => (
                    ...
                    >
                      <input
                        ...
                        id={`option-${index}-${i}`}
                        name={`option-${index}-${i}`}
                        className="form-checkbox rounded-xl h-5 w-5 text-blue-600"
                      />
                      <label
          ...
          <div
            className={`FreelancerExplore ${showDetails ? "show-details" : ""}`}
          >
