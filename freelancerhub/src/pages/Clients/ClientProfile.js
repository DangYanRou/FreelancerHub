      ...
      <div className='profileCard'>
        ...
        <div className='profile_text'>
                ...
                <p className="address" style={{fontSize:14}}>
                  ...
                  Universiti Malaya</p>
                <p className='phone' style={{fontSize:14}}>Phone: +60 034042-1072 </p>
        </div>
        ...
        <div className='lowerProfile'>
          <nav className='profileNav'>
              <div className="navigation">
                  <ul className="nav-links">
                    ...
                    <li><a href="#projectPosted" onClick={() => handleProfileNavClick('projectPosted')}>Project Posted</a></li>
          ...
          <div className='Card2'>
            ...
            <div id="affiliatedCompanies" style={{ display: showCompanies ? 'block' : 'none' }}>
              ...
              <div className='projects_container'>
                <div className='about_details'>
                  ...
                  <h4 className='company_name' style={{fontWeight:500}}>Google, Social Marketing Tools</h4>
                </div>
                <div className='about_details'>
                  <div className='btn_container'>
                    <img src={youtube}></img>
                  </div>
                  <h4 className='company_name' style={{fontWeight:500}}>Youtube</h4>
                </div>
                <div className='about_details'>
                  <div className='btn_container'>
                    <img src={nest}></img>
                  </div>
                  <h4 className='company_name' style={{fontWeight:500}}>Nest</h4>
                </div>
              </div>
            </div>
            ...
            <div id="reviews" style={{ display: showReviews ? 'block' : 'none' }}>
              <p className='projects_text' style={{paddingLeft:20}}>Let Us Listen To Others</p>
